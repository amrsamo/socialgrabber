              ...
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  <div class="input-group">
                    <input type="text" id="q" class="form-control" placeholder="Hashtag/Keyword" <?= (isset($_GET['username']))? "value='".$_GET['username']."'" : '' ; ?>>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered bulk_action" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <?php if (is_array($top_hashtags)): ?>
                          <?php $counter = 1; ?>
                          <?php foreach ($top_hashtags as $hashtag): ?>
                          <tr>
                            <td><?= $counter; ?></td>
                            <td><?= $hashtag->text ?></td>
                            <td><?= $hashtag->count ?></td>
                            <td><a href=" <?= base_url(); ?>instagram/hashtag/<?= $hashtag->text; ?> ">
                              <button>Users</button>
                            </a></td>
                        </tr>
                        <?php $counter++; ?>
